                ...
                <tr>
                    <td>
                        ...
                        <table class="tbl_body" style="width:100%;background-color:#ffffff;min-height:80px;direction:rtl;" cellspacing="0" cellpadding="10px">
                            ...
                            <tr>
                                <td></td>
                                <td><font style="font-family:tahoma;font-size:12px;">از ایجاد حساب کاربری در {{ $site_name}} از شما سپاسگذاریم</font></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td></td>
                            ...
                            <tr>
                                <td></td>
                               <td><font style="font-family:tahoma;font-size:12px;">کلمه عبور: {{ $password }}</font></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td></td>
