...
class ModuleFrontController extends FrontController
{
    ...
    {
        $this->assign->params([
            'module_resource'=>$this->renderTplName(false),
            'module'=>$this->module,
        ]);
    ...
    protected function renderTplName($full=true)
    {
        if($full)
            return 'module_resource::' . $this->module->author . '.' . $this->module->name . '.resources.'.$this->folder.'.'. $this->tpl;
        else
            return 'module_resource::' . $this->module->author . '.' . $this->module->name . '.resources.'.$this->folder.'.';
    }
}