...
class Tree
{
     ...
     * @return array
     */
    public static function prepareArray(Collection $collection,$selected_ids=[],$unSelectables=[],$primary='id',$parent_key='parent_id',$name='name')
    {
        $tree = [];
     ...
     * @return array
     */
    public static function render(Collection $collection,$selected_ids=[],$unSelectables=[],$primary='id',$parent_key='parent_id',$name='name')
    {
        $results = self::prepareArray($collection,$selected_ids,$unSelectables,$primary,$parent_key,$name);
        $new = [];
